...
Relation_loss_lambda = 0.1
Relation_loss_lambda = args.Relation_loss_lambda

evi_loss = True
attn_loss = True
if args.not_attn_loss:
    attn_loss = False
else:
    attn_loss = True
...
run_save_file = "./Redoc_Logs/" + path + ".txt"
...
fprint("_Crht_loss", Crht_loss)
fprint("_Emb_loss", Emb_loss)
fprint("_Relation_loss", Relation_loss)
fprint("__Relation_loss_lambda", Relation_loss_lambda)

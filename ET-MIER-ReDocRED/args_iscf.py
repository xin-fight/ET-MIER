...
def add_args(parser):
    parser.add_argument("--loss_weight_ET", default=0.25, type=float)
    parser.add_argument("--s_attn_lambda", default=0, type=float)
    parser.add_argument("--not_attn_loss", action="store_true")
    parser.add_argument("--Relation_loss_lambda", default=0.1, type=float)
    parser.add_argument("--ishas_enhance_evi", action="store_true")
    parser.add_argument("--TSER_Logsumexp", action="store_true")
    parser.add_argument("--three_atten", action="store_true")
    ...
    parser.add_argument("--display_name", default="ATLOP_DRE_ISCF", type=str)
